        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 border-b border-cocoa-800 pb-12">
          ...
          <div className="md:col-span-1">
            <h2 className="font-serif text-4xl mb-6">
              NOLITA <span className="italic text-gold-500">cacao</span>
            </h2>
            <p className="font-sans text-sm text-cocoa-200 leading-relaxed mb-6">
              Crafting exquisite chocolates that celebrate the art of
              indulgence. Ethically sourced, Swiss precision, Indian soul.
            </p>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="font-serif text-xl mb-6 text-gold-500">
              Stay Indulgent
            </h3>
            <p className="font-sans text-sm text-cocoa-200 mb-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-cocoa-300 font-sans">
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-8 mb-4 md:mb-0">
            <span className="flex items-center gap-2">
              <Globe className="w-4 h-4" /> www.nolitacacao.com
            </span>
            <span className="flex items-center gap-2">
              <Phone className="w-4 h-4" /> +91-9380500300
            </span>
            <span className="flex items-center gap-2">
              <Mail className="w-4 h-4" /> nolitacacao@gmail.com
            </span>
          </div>
          <p>&copy; 2025 Nolita Cacao. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
